...
<div class="container mt-1">
  <div class="row">
    ...
    <div class="col text-end mt-1">
      <a href="../pages/r_home.php" class="btn btn-danger"><i class="bi bi-arrow-left-circle m-1"></i>BACK</a>
    </div>
  </div>
</div>
      ...
      <form id="campaign" class="row g-3 needs-validation d-flex p-5" method="post" enctype="multipart/form-data" novalidate>
        ...
        ?>
          ...
          <div class="col-12 d-flex justify-content-between">
            <input  type="submit" class="btn btn-primary" value="Update"name="r_update">
