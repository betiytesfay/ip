...
$update = "UPDATE users SET fname='$fname', lname='$lname', email='$email', phone='$phone', place='$place', emp_status='$emp_status', user_type='$user_type',blood_type='$b_type', password='$password', profile_pic='$profile' WHERE user_id='$id'";
...
if ($exe) {
    ...
    $_SESSION['admin_logged'] =$fname;
    $_SESSION['aprofile_pic'] = $profile;
    ...
    <div class="container">
        <div class="card mt-5 mx-auto">
            <div class="card-header d-flex justify-content-between align-items-center  ">
                ...
                <a href="admin.php" class="btn btn-danger"><i class="bi bi-arrow-left-circle m-1"></i>BACK</a>
            </div>
            <div class="card-body ">
            <?php
             if(isset($_GET['id'])){
...
function confirmPasswordChange(event) {
    ...
    // const btype = document.getElementById('bg_type');
    // const select = document.getElementById('validationCustom07');
